...
path='/datasets/work/oa-coconet/work/OceanParcels-GBR/outputs/Coral/' + release_start_day
...
ds = xr.Dataset(
        data_vars={
            'connectivity_sum': xr.DataArray(
                ...
                coords={'source_reef': jobs, 'destination_reef': jobs}
            ),
...
path_save='/datasets/work/oa-coconet/work/OceanParcels_outputs/Coral/Connectivity_matrix'
# Add metadata
ds.attrs['creation_date'] = time.strftime("%Y-%m-%d")
ds.attrs['description'] = ['Connectivity matrices for coral reef larvae dispersal for release date', time.strftime("%Y-%m-%d")]

# Save to NetCDF file
output_file = f"{path_save}/{release_start_day}_connectivity_matrices.nc"
