...
## ~   main ~ ##
## ~~~~~~~~~~ ##
shapefile = '/home/por07g/Documents/Projects/GBR_modeling/GBR_oceanparcels/GBR_main/Shape_files/gbr1_coral_1m_merged_buffer0p001.shp'
...
direction_outFile = open('output/GBR_reefs_direction.csv', 'w')
angle_outFile = open('output/GBR_reefs_angles.csv', 'w')
distance_outFile = open('output/GBR_reefs_distance.csv', 'w')
